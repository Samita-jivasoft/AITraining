 ...
 * `.claude/hooks/check-conventions.js`, then replace the example rules with
 ...
 *       "hooks": [{ "type": "command",
 *         "command": "node \"$CLAUDE_PROJECT_DIR/.claude/hooks/check-conventions.js\"" }] }]
 *   }
 *
...
process.stdin.on('end', () => {
  ...
  // Simple BLOCK example — register on PreToolUse.
  // Lock files are generated by package managers, not edited by hand.
  // To exercise it, ask Claude to edit package-lock.json.
